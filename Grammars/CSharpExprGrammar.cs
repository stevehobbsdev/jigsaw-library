...
namespace Diggins.Jigsaw.Grammars
{
    class CSharpExprGrammar : CSharpLiteralsGrammar
    {
        ...
        public static Rule Statement = Node(Block | ExprStatement);
        ...
        public static Rule LambdaParam = Node(Opt(TypeExpr) + WS + Identifier + WS);
        public static Rule LambdaParams = Node(LambdaParam | Parenthesize(CommaDelimited(LambdaParam)));
        ...
        public static Rule LeafExpr = Node(LambdaExpr | ParenthesizedExpr | NewExpr | Identifier | Integer | Float | String);
